...
<div class="container">
  ...
  <center>
    <table style="small" width="700" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#85B64A"><strong>Standard price charged </strong></td>
      ...
      <tr>
        ...
        <td bgcolor="#C4DBA8"><span id="sessions" class="style2"><strong>Session 1 </strong><br>
...
?>
		  ...
		  <em>(warning - changing this will clear all previously entered sessions)</em> </td>
      </tr>
      <tr>
        <td bgcolor="#85B64A">&nbsp;</td>
        <td bgcolor="#C4DBA8">&nbsp;</td>
